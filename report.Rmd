...
![Top 15 Operating Systems by Number of WDQS Users, Not Known Automata Only. It looks like Ubuntu users have more queries-per-user than other operating systems on average.](figures/n_user_by_os.png)
...
![Adjusted number of queries decomposition. BFAST method detect a change point on Aug 14 in the trend component. At the change point, the decrease may be a result of our adjustment (excluding US spiders), and more observations are needed to confirm the increase afterwards.](figures/adjust_query_decompose.png)
