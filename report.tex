...
\hypersetup{unicode=true,
            ...
            pdfauthor={Chelsy Xie (Analysis \& Report); Mikhail Popov (Review)},
...
% using explicit options in \includegraphics[width=11cm,height=11cm,keepaspectratio][width, height, ...]{}
